...
- Use a CDN (Content Delivery Network) to deliver your media files: https://cloudinary.com/ (cloudinary has a free tier) -> [Documentation](https://cloudinary.com/documentation/image_optimization).
